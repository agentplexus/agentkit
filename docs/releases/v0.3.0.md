...
agents:
  - name: research
    containerImage: ghcr.io/plexusone/stats-agent-research:v0.5.1
    memoryMB: 512
    timeoutSeconds: 30
    protocol: HTTP
  ...
  - name: orchestration
    containerImage: ghcr.io/plexusone/stats-agent-orchestration:v0.5.1
    memoryMB: 512
    timeoutSeconds: 300
    protocol: HTTP
    isDefault: true
...
```bash
go get github.com/plexusone/agentkit@v0.3.0
```
