...
```go
import "github.com/plexusone/agentkit/mcp"
...
```go
import "github.com/plexusone/agentkit/platforms/local"
...
| `github.com/plexusone/omnivault` | 0.2.0 | 0.2.1 |
| `github.com/plexusone/omniobserve` | 0.5.0 | 0.5.1 |

## Installation

```bash
go get github.com/plexusone/agentkit@v0.4.0
```
